...
function measureCard(ctx, stats, hovered, slots) {
  ...
  for (const row of STAT_ROWS) {
    ...
    if (row.key === 'aggroRange') {
      ...
      else if (hovered.typeId === 'bee' || hovered.typeId === 'centipede_head' || hovered.typeId === 'worker_ant' || hovered.typeId === 'desert_centipede_head') valStr = 'Passive (until hit)';
      else if (hovered.typeId === 'cactus') valStr = 'Static';
