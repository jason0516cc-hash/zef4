...
const ICON_OVERRIDES = {
  ...
  "Iris":           { rot:   0, scale: 0.50, ox:  0, oy:  -3, nameSize: 2.00 }, // half-size icon
  "Sand":           { rot:   0, scale: 0.47, ox:  0, oy:  -5, nameSize: 2.00 }, // matches Peas' icon size exactly (no rotation, unlike Peas)
  "Stick":          { rot:  25, scale: 0.61, ox:  0, oy:   4, nameSize: 2.00 }, // rotated a bit more; scale compensates for the bigger world size
  ...
  "Beetle Egg":     { rot:   0, scale: 0.60, ox:  0, oy:  -2, nameSize: 2.00 }, // bumped up a little from 0.50
  "Pincer":         { rot:  15, scale: 0.47, ox:  0, oy:  -3, nameSize: 2.00 }, // tilt direction reverted back
  "Bone":           { rot:   0, scale: 0.50, ox:  0, oy:  -3, nameSize: 2.00 }, // counteracts the 2x DRAW_SCALE bump so the icon stays the old size
};
