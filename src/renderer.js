...
import { drawMob, drawSpider, drawBee, drawQueenBee, drawLadybug, drawCentipedeHead, drawCentipedeBody, drawHornet, drawMissile,
         ...
         drawDesertCentipedeHead, drawDesertCentipedeBody, drawBeetle, drawSandstorm, drawCactus,
         drawFireSoldierAnt, drawFireWorkerAnt, drawFireQueenAnt, drawFireAntEgg, drawFireAntHole,
...
function drawSingleMobBox(ctx, typeId, rarity, count, cx, cy, scaleAmt, spinAng, alpha, countBounceT = 1, isBoss = false) {
  ...
  switch (typeId) {
    ...
    case 'cactus':
      drawCactus(ctx, 0, 0, iconR * 1.1, true);
      break;
    case 'scorpion': {
